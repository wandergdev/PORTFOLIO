    ...
    <section id="top" className="mx-auto max-w-5xl px-6 pt-20 pb-24 sm:pt-28 sm:pb-32">
      <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="flex flex-col gap-6">
          <span className="inline-flex w-fit items-center rounded-full bg-indigo-500/10 px-3 py-1 text-xs font-medium tracking-wide text-indigo-400">
            SOY DESARROLLADOR BACKEND
          </span>

          <h1 className="text-4xl font-medium leading-[1.1] tracking-tight text-zinc-50 sm:text-5xl">
            Hola, soy <span className="text-indigo-400">{firstName}</span>
            <span className="mt-2 block text-zinc-50">
              Construyo backends robustos y confiables.
            </span>
          </h1>
        ...
        <div className="relative mx-auto w-full max-w-sm">
          ...
          <div className="absolute -bottom-6 -left-6 hidden w-56 rounded-xl border border-white/10 bg-zinc-900/90 p-4 font-mono text-[11px] leading-relaxed text-zinc-400 shadow-xl backdrop-blur sm:block">
            ...
            <p className="pl-3">
              foco: <span className="text-emerald-400">&quot;APIs & auth&quot;</span>,
            </p>
            <p>{"}"}</p>
          </div>
        </div>
